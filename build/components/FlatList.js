...
var _ScrollView=require('./ScrollView');var _ScrollView2=_interopRequireDefault(_ScrollView);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{'default':obj};}var

PropTypes=_react2['default'].PropTypes;
var SCROLLVIEW_REF='flatlistscroll';


var FlatList=_react2['default'].createClass({displayName:'FlatList',
propTypes:_extends({},
...
return{
renderScrollComponent:function(){function renderScrollComponent(props){return _react2['default'].createElement(_ScrollView2['default'],_extends({},props,{__source:{fileName:_jsxFileName,lineNumber:149}}));}return renderScrollComponent;}()};
