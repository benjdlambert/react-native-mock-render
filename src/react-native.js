...
const ReactNative = {
  // Components
  ActivityIndicator: require('./components/ActivityIndicator').default,
  ActivityIndicatorIOS: require('./components/ActivityIndicatorIOS').default,
  ART: require('./components/ART').default,
  Button: createMockComponent('Button'),
  DatePickerIOS: createMockComponent('DatePickerIOS'),
  DrawerLayoutAndroid: require('./components/DrawerLayoutAndroid').default,
  ...
  ListView: require('./components/ListView').default,
  MapView: createMockComponent('MapView'),
  Modal: createMockComponent('Modal'),
  Navigator: require('./components/Navigator').default,
  NavigatorIOS: createMockComponent('NavigatorIOS'),
  Picker: require('./components/Picker').default,
  ...
  TabBarIOS: require('./components/TabBarIOS').default,
  ...
  WebView: require('./components/WebView').default,
